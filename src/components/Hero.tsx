...
const Hero: React.FC = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.8)), url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')`,
    ...
    >
      ...
      <div className="mx-auto w-full lg:max-w-[64rem] px-4 text-center relative z-10">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 animate-float">
        ...
        <p
          className="dark:text-dark-secondary text-light-secondary text-lg md:text-2xl mb-10 md:mb-16 max-w-3xl mx-auto px-4 leading-relaxed animate-float"
          style={{ animationDelay: '0.2s' }}
        >
          Unlock powerful cheats to easily defeat skilled players and take control of every match
          with <span className="text-primary-400 font-semibold">confidence</span>.
        </p>
        <div
          className="flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-8 px-4"
          style={{ animationDelay: '0.4s' }}
        >
          <a
            href="#games"
            className="group relative w-full sm:w-auto bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white px-10 md:px-12 py-5 md:py-6 rounded-3xl text-lg md:text-xl font-semibold transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-primary-500/50 flex items-center justify-center overflow-hidden animate-glow"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="absolute inset-0 animate-shimmer opacity-0 group-hover:opacity-100"></div>
            <FaGamepad className="mr-4 text-4xl group-hover:rotate-12 group-hover:scale-125 transition-transform duration-500" />
          ...
          <a
            ...
            className="group relative w-full sm:w-auto text-white px-10 md:px-12 py-5 md:py-6 rounded-3xl text-lg md:text-xl font-semibold transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-purple-500/50 flex items-center justify-center border-2 border-purple-400 glass-dark backdrop-blur-xl overflow-hidden"
          >
            ...
            <div className="absolute inset-0 animate-shimmer opacity-0 group-hover:opacity-100"></div>
            <FaDiscord className="mr-4 text-4xl group-hover:bounce group-hover:scale-125 transition-transform duration-500" />
      ...
      <button
        onClick={scrollDown}
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-dark-secondary dark:text-dark-secondary text-light-secondary hover:text-primary-400 transition-all duration-500 hover:scale-125 animate-bounce group"
