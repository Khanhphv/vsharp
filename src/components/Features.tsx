            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500">
                  <div className="p-4 rounded-2xl bg-gradient-to-br from-primary-500/20 to-purple-600/20 group-hover:from-primary-500/30 group-hover:to-purple-600/30 transition-all duration-500">
                    {feature.icon}
                  </div>
                </div>
                <h3 className="text-lg md:text-xl font-bold mb-3 dark:text-dark-primary text-light-primary group-hover:text-primary-400 transition-colors duration-300">
                  {feature.title}
                </h3>
              ...
              <div className="absolute top-4 right-4 w-2 h-2 bg-primary-500/30 rounded-full animate-pulse"></div>
              <div className="absolute bottom-6 left-6 w-1 h-1 bg-purple-500/40 rounded-full animate-ping"></div>
            </div>
          ))}
        </div>
      </div>
